...
public class Client implements Runnable {
	...
	public void run() {
		...
		if (clientOperation.equals("sending")) {
			...
			System.out.printf("Terminating sending client thread -  Running time %d milliseconds\n", sendClientEndTime - sendClientStartTime);
			...
			System.out.printf("Terminating receiving client thread -  Running time %d milliseconds\n", receiveClientEndTime - receiveClientStartTime);
