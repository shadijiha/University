...
public class Player extends GameObject {
	...
	public Player(Player objToCopy) {
		...
		if (objToCopy == null) {
			...
			System.err.println(String.format("The object to copy is not defined! @ %s.%s:%s", l.getClassName(),
	...
	public String toString() {
		return String.format("The player \"%s\" is at level %d, x: %d, y: %d and has %d energy", this.name, this.level,
				this.x, this.y, this.energy);
	}
}
