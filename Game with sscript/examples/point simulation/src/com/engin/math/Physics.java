...
public abstract class Physics {
	...
	public static boolean collisionBetween(Shape shape1, Shape shape2) {
		...
		if (shape1 instanceof Rectangle && shape2 instanceof ICoordinates2F)
			return collisionBetween((Rectangle) shape1, (ICoordinates2F) shape2);

		if (shape2 instanceof Rectangle && shape1 instanceof ICoordinates2F)
			return collisionBetween((Rectangle) shape2, (ICoordinates2F) shape1);

		if (shape1 instanceof Circle && shape2 instanceof ICoordinates2F)
			return collisionBetween((Circle) shape1, (ICoordinates2F) shape2);

		if (shape2 instanceof Circle && shape1 instanceof ICoordinates2F)
			return collisionBetween((Circle) shape2, (ICoordinates2F) shape1);
	...
	public static boolean collisionBetween(Rectangle rect1, ICoordinates2F point) {
	...
	public static boolean collisionBetween(Circle circle, ICoordinates2F point) {
	...
	public static double distance(ICoordinates2F point1, ICoordinates2F point2) {
